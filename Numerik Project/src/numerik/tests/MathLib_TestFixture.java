...
public class MathLib_TestFixture
{
    ...
    public void round__Exponent_Of_Decimal_Is_30_And_Precision_Is_12()
    {
        ...
        assertEquals("1.11111111112E+30", m_BigDecimalOutput.toEngineeringString());
    }
    ...
    public void round__Exponent_Of_Decimal_Is_Minus_20_And_Precision_Is_10()
    {
        ...
        assertEquals("11.11111112E-21", m_BigDecimalOutput.toEngineeringString());
    }
    ...
    public void round__Exponent_Of_Decimal_Is_Minus_5_And_Precision_Is_20()
    {
        ...
        assertEquals("0.000011111111111111111112", m_BigDecimalOutput.toPlainString());
    }
...
//    }
    ...
    @Test
    public void stripTrailingZeros__Test_1()
    {
        m_BigDecimalInput = new BigDecimal("0.0000");
        m_BigDecimalOutput = MathLib.stripTrailingZeros(m_BigDecimalInput);
        
        m_BigDecimalStringOutput = m_BigDecimalOutput.toPlainString();
        
        assertEquals("0", m_BigDecimalStringOutput);
    }
    
    
    @Test
    public void stripTrailingZeros__Test_2()
    {
        m_BigDecimalInput = new BigDecimal("4340.3423200");
        m_BigDecimalOutput = MathLib.stripTrailingZeros(m_BigDecimalInput);
        
        m_BigDecimalStringOutput = m_BigDecimalOutput.toPlainString();
        
        assertEquals("4340.34232", m_BigDecimalStringOutput);
    }
    
    
    @Test
    public void stripTrailingZeros__Test_3()
    {
        m_BigDecimalInput = new BigDecimal("213230.001232300");
        m_BigDecimalOutput = MathLib.stripTrailingZeros(m_BigDecimalInput);
        
        m_BigDecimalStringOutput = m_BigDecimalOutput.toPlainString();
        
        assertEquals("213230.0012323", m_BigDecimalStringOutput);
    }
    
    
    @Test
    public void stripTrailingZeros__Test_4()
    {
        m_BigDecimalInput = new BigDecimal("0.0012312300");
        m_BigDecimalOutput = MathLib.stripTrailingZeros(m_BigDecimalInput);
        
        m_BigDecimalStringOutput = m_BigDecimalOutput.toPlainString();
        
        assertEquals("0.00123123", m_BigDecimalStringOutput);
    }
    
    
    @Test
    public void stripTrailingZeros__Test_5()
    {
        m_BigDecimalInput = new BigDecimal("12");
        m_BigDecimalOutput = MathLib.stripTrailingZeros(m_BigDecimalInput);
        
        m_BigDecimalStringOutput = m_BigDecimalOutput.toPlainString();
        
        assertEquals("12", m_BigDecimalStringOutput);
    }
    
    
    @Test
    public void stripTrailingZeros__Test_6()
    {
        m_BigDecimalInput = new BigDecimal("12.0");
        m_BigDecimalOutput = MathLib.stripTrailingZeros(m_BigDecimalInput);
    ...
    @Test
    public void stripTrailingZeros__Test_7()
    {
        m_BigDecimalInput = new BigDecimal("0");
        m_BigDecimalOutput = MathLib.stripTrailingZeros(m_BigDecimalInput);
