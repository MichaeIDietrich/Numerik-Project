...
public class LUDecomposition
{
    ...
    public void init()
    {
        ...
        BigDecimal     kappa = MathLib.round( invA.norm().multiply( A.norm() ));
        BigDecimal relFehler = MathLib.round( kappa.multiply( r.norm().divide( b.norm(), MathLib.getPrecision(), RoundingMode.HALF_UP) ));
