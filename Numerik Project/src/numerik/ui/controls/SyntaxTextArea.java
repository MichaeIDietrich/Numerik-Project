...
public class SyntaxTextArea extends JTextPane
{
    ...
    public SyntaxTextArea(java.util.List<String> items) {
      filter = new ListFilter(items);
      ...
      list.addMouseListener(new MouseAdapter() {
        ...
        public void mouseClicked(MouseEvent e) {
          // selects the key from the list and changes yout text field text
          if (e.getButton() == MouseEvent.BUTTON1 && e.getClickCount() == 2) {
//            ProposalTextArea.this.replaceRange(list.getSelectedValue(), getInputStart(), ProposalTextArea.this.getCaretPosition());
...
//              System.out.println("cursor: " + ProposalTextArea.this.getCaretPosition() + " - " + doc.getLength());
          }
        ...
        public void keyPressed(KeyEvent e) {
          if (popupVisible) {
            // lets you use the up and down key to navigate through the list
    ...
    private int getInputStart() {
      ...
      System.out.println("start: " + (start + 1) + ", " + cursor + " , text: " + text);
      return ++start;
    }
    ...
    private void highlightSyntax() {
      ...
      while (true) {
        ...
        while (++end < doc.getLength()) {
          ...
          if (content[end] == '(') 
            state = 1;
          if (!isWord(content[end])) break;
        }
        
//        System.out.println(start + " - " + end);
        if (state == 1) {
          System.out.println("F: " + text.substring(start, end));
          ...
          System.out.println("V: " + text.substring(start, end));
          if (filter.getList().contains(text.substring(start, end))) {
            doc.setCharacterAttributes(start, end - start, ERROR, true);
          } else if (text.substring(start, end).equals("var")) {
